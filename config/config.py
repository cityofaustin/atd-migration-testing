DIR_GITHUB_DOWNLOAD = "data/github_download"
DIR_GITHUB_CREATE = "data/github_create"
DIR_GITHUB_UPDATE = "data/github_update"
DIR_ZENHUB = "data/zenhub_download"
DIR_LABELED = "data/labeled"
DIR_MILESTONES = "data/milestones"
